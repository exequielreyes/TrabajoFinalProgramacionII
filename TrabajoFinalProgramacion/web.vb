...
Public Class web
    ...
    Public Sub OpenPreviewWindowCliente()
        ...
        hHwnd = capCreateCaptureWindowA(iDevice, WS_VISIBLE Or WS_CHILD, 0, 0, 600,
           480, FormCliente.PicFoto.Handle.ToInt32, 0)
        ...
        If SendMessage(hHwnd, WM_CAP_DRIVER_CONNECT, iDevice, 0) Then
            ...
            ' Resize window to fit in picturebox
            '
            SetWindowPos(hHwnd, HWND_BOTTOM, 0, 0, FormCliente.PicFoto.Width, FormCliente.PicFoto.Height,
                    SWP_NOMOVE Or SWP_NOZORDER)
    ...
    Public Sub CapturarCliente()
        ...
        FormCliente.PicFoto.Image = IMAGEN
